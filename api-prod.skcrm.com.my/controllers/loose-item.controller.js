...
exports.LooseItemController = void 0;
...
let LooseItemController = class LooseItemController {
    constructor(looseItemRepository, multerFileService) {
        this.looseItemRepository = looseItemRepository;
        this.multerFileService = multerFileService;
    }
    async create(looseItem) {
        return this.looseItemRepository.create(looseItem);
    }
    async count(where) {
        return this.looseItemRepository.count(where);
    }
    async find(filter) {
        return this.looseItemRepository.find(filter);
    }
    async updateAll(looseItem, where) {
        return this.looseItemRepository.updateAll(looseItem, where);
    }
    async findById(id, filter) {
        return this.looseItemRepository.findById(id, filter);
    }
    async updateById(id, looseItem) {
        await this.looseItemRepository.updateById(id, looseItem);
    }
    async replaceById(id, looseItem) {
        await this.looseItemRepository.replaceById(id, looseItem);
    }
    async deleteById(id) {
        await this.looseItemRepository.deleteById(id);
    }
    async uploads(request, response) {
        ...
        if (!uploadModeIsUpdate) {
            ...
            await this.looseItemRepository.deleteAll(); // Delete all item records first, before inserting from jsonSheet
        }
        for (const data of jsonSheet) {
            const model = new models_1.LooseItem();
            let trimmedKey;
            ...
            */
            if (uploadModeIsUpdate) {
                ...
                const item = await this.looseItemRepository.findOne({
                    where: { name: model.name },
                });
                // console.log(`Item: ${JSON.stringify(item)}`);
                if (item) {
                    // console.log('Existing item, update for now');
                    updatePromises.push(this.looseItemRepository.updateById(item.uuid, model));
        ...
        await this.looseItemRepository.createAll(createModels);
...
tslib_1.__decorate([
    rest_1.post('/loose-items', {
        responses: {
            '200': {
                description: 'LooseItem model instance',
                content: { 'application/json': { schema: rest_1.getModelSchemaRef(models_1.LooseItem) } },
            },
        },
    }),
    tslib_1.__param(0, rest_1.requestBody({
        content: {
            'application/json': {
                schema: rest_1.getModelSchemaRef(models_1.LooseItem, {
                    title: 'NewLooseItem',
                    exclude: ['uuid'],
                }),
            },
...
], LooseItemController.prototype, "create", null);
tslib_1.__decorate([
    rest_1.get('/loose-items/count', {
        responses: {
            '200': {
                description: 'LooseItem model count',
                content: { 'application/json': { schema: repository_1.CountSchema } },
            },
        },
    }),
    tslib_1.__param(0, rest_1.param.where(models_1.LooseItem)),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", Promise)
], LooseItemController.prototype, "count", null);
tslib_1.__decorate([
    rest_1.get('/loose-items', {
        responses: {
            '200': {
                description: 'Array of LooseItem model instances',
                content: {
                    'application/json': {
                        schema: {
                            type: 'array',
                            items: rest_1.getModelSchemaRef(models_1.LooseItem, { includeRelations: true }),
                        },
                    },
                },
            },
    ...
    tslib_1.__param(0, rest_1.param.filter(models_1.LooseItem)),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [Object]),
    tslib_1.__metadata("design:returntype", Promise)
], LooseItemController.prototype, "find", null);
tslib_1.__decorate([
    rest_1.patch('/loose-items', {
        responses: {
            '200': {
                description: 'LooseItem PATCH success count',
                content: { 'application/json': { schema: repository_1.CountSchema } },
            },
        },
    }),
    tslib_1.__param(0, rest_1.requestBody({
        content: {
            'application/json': {
                schema: rest_1.getModelSchemaRef(models_1.LooseItem, { partial: true }),
            },
        },
    })),
    tslib_1.__param(1, rest_1.param.where(models_1.LooseItem)),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [models_1.LooseItem, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], LooseItemController.prototype, "updateAll", null);
tslib_1.__decorate([
    rest_1.get('/loose-items/{id}', {
        responses: {
            '200': {
                description: 'LooseItem model instance',
                content: {
                    'application/json': {
                        schema: rest_1.getModelSchemaRef(models_1.LooseItem, { includeRelations: true }),
                    },
                },
            },
        },
    ...
    tslib_1.__param(1, rest_1.param.filter(models_1.LooseItem, { exclude: 'where' })),
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, Object]),
    tslib_1.__metadata("design:returntype", Promise)
], LooseItemController.prototype, "findById", null);
tslib_1.__decorate([
    rest_1.patch('/loose-items/{id}', {
        responses: {
            '204': {
                description: 'LooseItem PATCH success',
            },
        },
    }),
    tslib_1.__param(0, rest_1.param.path.string('id')),
    ...
    tslib_1.__metadata("design:type", Function),
    tslib_1.__metadata("design:paramtypes", [String, models_1.LooseItem]),
    tslib_1.__metadata("design:returntype", Promise)
], LooseItemController.prototype, "updateById", null);
tslib_1.__decorate([
    rest_1.put('/loose-items/{id}', {
        responses: {
            '204': {
                description: 'LooseItem PUT success',
            },
        },
    }),
    tslib_1.__param(0, rest_1.param.path.string('id')),
    ...
    tslib_1.__metadata("design:paramtypes", [String, models_1.LooseItem]),
    tslib_1.__metadata("design:returntype", Promise)
], LooseItemController.prototype, "replaceById", null);
tslib_1.__decorate([
    rest_1.del('/loose-items/{id}', {
        responses: {
            '204': {
                description: 'LooseItem DELETE success',
            },
        },
    }),
    tslib_1.__param(0, rest_1.param.path.string('id')),
    ...
    tslib_1.__metadata("design:returntype", Promise)
], LooseItemController.prototype, "deleteById", null);
tslib_1.__decorate([
    rest_1.post(`/loose-item-lists/batch/upload/xlsx`, {
        responses: {
            '200': {
    ...
    tslib_1.__metadata("design:returntype", Promise)
], LooseItemController.prototype, "uploads", null);
LooseItemController = tslib_1.__decorate([
...
exports.LooseItemController = LooseItemController;
//# sourceMappingURL=loose-item.controller.js.map