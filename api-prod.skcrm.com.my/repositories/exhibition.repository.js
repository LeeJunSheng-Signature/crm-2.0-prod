...
let ExhibitionRepository = class ExhibitionRepository extends repository_1.DefaultCrudRepository {
    constructor(dataSource) {
        super(models_1.Exhibition, dataSource);
    }
};
ExhibitionRepository = tslib_1.__decorate([
